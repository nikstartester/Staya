 ...
 * Пока жест не отпущен, фотография выходит за границы круга и может стать меньше него - с
 * сопротивлением, тем большим, чем дальше от допустимого положения. Отпускание плавно возвращает её
 * в границы: круг гарантированно закрыт только в устоявшемся состоянии, и обрезается именно оно.
 *
