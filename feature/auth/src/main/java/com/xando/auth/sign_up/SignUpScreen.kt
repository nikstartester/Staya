...
import com.xando.auth.sign_up.navigation.internal.SignUpAboutKey
import com.xando.auth.sign_up.navigation.internal.SignUpEmailPasswordKey
import com.xando.auth.sign_up.navigation.internal.SignUpIntroductionKey
import com.xando.auth.sign_up.navigation.internal.SignUpLoginKey
import com.xando.auth.sign_up.pages.about.SignUpAboutScreen
import com.xando.auth.sign_up.pages.email_password.SignUpEmailPasswordScreen
import com.xando.auth.sign_up.pages.introduction.SignUpIntroductionScreen
import com.xando.auth.sign_up.pages.login.SignUpLoginScreen
    ...
    Scaffold(
        ...
        LaunchedEffect(Unit) {
            viewModel.events
                ...
                .collect { event ->
                    when (event) {
                        is SignUpFlowEvent.ShowSnackbar -> snackbarController.show(event.snackbarData)

                        SignUpFlowEvent.NavigateToLoginStep -> navigationController.navigateAndPopUpTo(
                            destination = SignUpLoginKey,
                            popUpTo = SignUpLoginKey,
                            inclusive = true
                        )
                    }
                }
